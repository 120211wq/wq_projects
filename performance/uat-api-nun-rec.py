...
class test_task(TaskSet):
    ...
    def test_upload(self):
        # 定义requests的请求头
        header = {"Group":"GATEWAY-REGISTER-DEMO","stage":"TEST","Content-Type":"application/json"}
        url = 'http://zhsq-iot-api2.sunac.com.cn/v2/service/iot-gateway-register/bench'
        body = {

                }
        # r是包含所有响应内容的一个对象
        r = self.client.get(url, json=body, headers=header)
