...
class test_task(TaskSet):
    ...
    def test_upload(self):
        # 定义requests的请求头
        header = {"Group":"GATEWAY-REGISTER-DEMO","stage":"TEST","Content-Type":"application/json","Access-Token":"OUQwRUYzNTIxNzM4MzE3ODc3NDMzMUNBMTdBNTA1NjNGRkM1MzQ3MzhFM0ZCNTI4NDJCRUFCRUY3OUYxQUY4NQ=="}
        url = 'http://zhsq-iot-api2.sunac.com.cn/v2/service/iot-gateway-register/bench-frontend'
